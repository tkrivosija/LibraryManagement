               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-4 mb-3 d-grid gap-2">
                        <asp:Button ID="Button1" class="btn btn-lg btn-success col-12" runat="server" Text="Add" />
                     </div>
                     <div class="col-4 mb-3 d-grid gap-2">
                        <asp:Button ID="Button3" class="btn btn-lg btn-warning col-12" runat="server" Text="Update" />
                     </div>
                     <div class="col-4 mb-3 d-grid gap-2">
                        <asp:Button ID="Button2" class="btn btn-lg btn-danger col-12" runat="server" Text="Delete" />
                     </div>
                  </div>
               </div>
            </div>
